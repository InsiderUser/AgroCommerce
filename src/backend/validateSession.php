    ...
    while ($row = pg_fetch_assoc($pg)) {
      ...
      <div class=\"row justify-content-between mx-1 mb-5\">
        <div class='d-flex align-items-center gap-2 mb-3 p-0'>
          ...
          <h5 id='cropClass' class='m-0 text-uppercase'>" . $row['tipo_cultivo'] . "</h5>
        </div>
          ...
          <div class=\"list-group\">
            ...
            <a class=\"list-group-item list-group-item-action\" style=\"cursor: default;\">
              ...
              <div class='d-flex flex-column'>
                ...
                <button onclick=\"window.location='../pages/ph-level.php'\"  style='display:$local_neg;' class='bg-light link link-secondary p-0 link-opacity-75-hover' type='link' id='btnMejorarPH'>
